...
of fifteen thousand papers is a few hundred requests rather than fifteen thousand. Before
1.7.1 arXiv was queried one paper per request and the per-run default was 200, which meant
covering a real corpus took seventy-nine presses of a button — bounded, but not usable.
