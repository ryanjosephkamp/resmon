...
.venv/bin/python -m pytest -q          # hermetic suite: 3110 pass, 4 skip, 108 deselected (CI, Python 3.11)
...
npm run e2e                                      # the real Electron app — 110 cases in 34 files, 29 routes; report actual pass/skip counts
