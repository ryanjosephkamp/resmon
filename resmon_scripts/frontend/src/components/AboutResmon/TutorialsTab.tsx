...
const sections: TutorialSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Chats in the sidebar browses saved conversations beyond the Ask history drawer, newest-created first. Filter saved titles or use Older chats; Refresh includes new chats. Select one transcript and Continue in Ask to reopen the same local conversation without sending a prompt.',
      'While Ask answers, other Chats remain readable and exportable. Finish or stop that answer before continuing another chat. Stop keeps the current turn until its reader settles; historical completion is unknown after reopening.',
      'Export Markdown or Export JSON explicitly downloads a persisted transcript, with nullable recorded metadata and no billing claim. Live fragments and pending approval cards are excluded. Includes saved messages and tool data: review before sharing. Each format refuses output above 8 MiB without truncation. Saved reads and exports need no available CLI.',
