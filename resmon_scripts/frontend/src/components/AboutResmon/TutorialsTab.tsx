...
const sections: TutorialSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Sorting by meaning is a *sort*, not a second search: the same papers come back in a different order, so switching it never changes which papers you are looking at.',
