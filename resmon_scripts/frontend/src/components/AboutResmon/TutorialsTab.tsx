...
const sections: TutorialSection[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'The `Assistant` section configures the panel behind the ✦ Ask button in the corner of every page. It uses the same `claude` command as the primary lane above — there is only one, so setting the path once is enough — and adds a model and an effort level. The status line says whether resmon can run it, and why not when it cannot.',
