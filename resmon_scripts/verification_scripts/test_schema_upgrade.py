...
def test_choices_upgrade_preserves_every_baseline_row_and_fts(tmp_path):
    ...
    assert database.get_schema_version(c) == 17
    ...
    assert set(choices_objects(c)) - set(old_objects) == set(database._ASSISTANT_CHOICES_DDL) | set(database._LIBRARY_DDL) | set(database._EVIDENCE_DDL)
